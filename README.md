...
1. **ایجاد یک ریپازیتوری در GitHub**
   ...
   - **نکته کد فعلی در فایل js به طور موقت فقط برای پاس دادن عکس استفاده شده و بقیه را رد میکیند لطفا کد های کامنت شده رو از حالت کامنت در بیارید و تابعی که اخر هست رو به طور کامل حذف کنید**.
